...
*/
tuple<double, uint64_t> estimate_pattern(Graph &graph, Pattern &pattern, uint64_t sampling_times, uint32_t *lost_edge_cases, default_random_engine &this_rand_generator) {
