...
public:
    ...
    */
    void dump() {
        cout << "Pattern's fractional cover value is " << fractional_cover_value << endl;
    ...
    */
    void load() {
        ...
        statstream >> fractional_cover_value;
        getline(infile, line);
        stringstream numstream(line);
        numstream >> cycle_num >> star_num;
    ...
    uint32_t star_num = 0;
    double fractional_cover_value = 0.0;
...
public:
    ...
    */
    Edge edge_sampling(default_random_engine &rand_generator) {
