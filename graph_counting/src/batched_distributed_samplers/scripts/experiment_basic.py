...
class Experiment(object):
    ...
    def exp(self, config):
        print '              *********** start running ***********'
        cmd = './GraphCounting.out ' + str(config['graph']) + ' ' + str(config['pattern']) + ' ' + str(config['sampling_times']) + ' 16 > ' + self.cur_exp_dir + '/running'
...
if __name__=='__main__':
    ...
    config = {
      'graph': ['./test_graphs/citeseer.undigraph', './test_graphs/mico.undigraph'],
      #'graph': ['./test_graphs/mico.undigraph'],
      'pattern': ['./patterns/triangle', './patterns/5_cycle', './patterns/triangle_2_star', './patterns/triangle_triangle', './patterns/2_star', './patterns/3_star', './patterns/3_star_2_star'],
      #'sampling_times': [10000, 100000, 1000000, 10000000, 100000000],
